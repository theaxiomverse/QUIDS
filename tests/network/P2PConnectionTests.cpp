...
TEST_F(P2PConnectionTest, MessageExchange) {
    ...
    connection2.set_message_handler([&](const std::string& peer_id, uint16_t port, const std::vector<uint8_t>& data) {
...
TEST_F(P2PConnectionTest, BroadcastToMultiplePeers) {
    ...
    connection3.set_message_handler([&](const std::string& peer_id, uint16_t port, const std::vector<uint8_t>& data) {
